...
# --- CẤU HÌNH ---
SOURCE_ROOT = './data/isic17'      # Thư mục chứa data to
    ...
    for split in ['test']:
        for type_dir in ['images', 'masks']:
            ...
            if not os.path.exists(src_dir):
                print(f"Cảnh báo: Không tìm thấy thư mục {src_dir}")
                continue
...
if __name__ == "__main__":
    print(f"Đang chuẩn bị resize tập TEST về {TARGET_SIZE}...")
    ...
    if not tasks:
        ...
        print(f"  {TARGET_ROOT}/test/images")
        print(f"  {TARGET_ROOT}/test/masks")
